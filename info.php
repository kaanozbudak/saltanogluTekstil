...
<body style="background: rgb(219, 235, 255); overflow-x: hidden !important;">

    <div class="container-fluid">
        <nav class="navbar navbar-default navbar-relative-top" id="navheight" role="navigation" style="margin-top: 2%;
        background: rgb(219, 235, 255); box-shadow: 0 0 0px; font-size: 19px; margin-bottom: 2%;">
            <div class="container">
                ...
                <div class="navbar-header">
                    ...
                    <a id="logo" href="index.html"><img src="img/logo.png" alt="SaltanogluTekstilLogo"></a>
                </div>
    ...
    <section class="jumbotron text-center" style="background:white !important;">
        <div class="container">
                ...
                <div class="col-md-4">
                    <div class="card mb-4 box-shadow">
                        <img class="card-img-top" data-src="holder.js/100px225?theme=thumb&amp;bg=55595c&amp;fg=eceeef&amp;text=Thumbnail"
                            alt="Thumbnail [100%x225]" style="height: 225px; width: 100%; display: block;" src="img/img01.jpg"
    ...
    <div id="contact" class="contact1" style="margin-bottom: 1%; background:white !important;">
        <div class="container-contact1">
            ...
            <form class="contact1-form validate-form" method="post" action="">
                ...
                <div class="wrap-input1 validate-input" data-validate="Message is required">
                    <textarea class="input1" name="message" maxlength="5000" placeholder="Message" required></textarea>
                    <span class="shadow-input1"></span>
                </div>

                <div class="container-contact1-form-btn">
                    <button type="submit" class="btn contact1-form-btn">
                        <span>
                            Mail'i Gönder
    ...
    <!-- Footer -->
    <section id="footer" style="background: rgb(190, 212, 236) !important;">
        <div class="container">
